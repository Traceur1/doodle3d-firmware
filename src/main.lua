...
-- The settings used are `log_path`, `api_log_filename` and `api_log_level`. The filename may
-- either be a regular file name (with an absolute log_path), or `<stdout>` or `<stderr>`.
...
local function setupLogger()
	...
	local logLevelSetting = settings.getSystemKey('api_log_level')
